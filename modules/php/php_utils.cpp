...
namespace kroll
{
	...
	/*static*/
	void PHPUtils::InitializePHPKrollClasses()
	{
		zend_class_entry ce;
		TSRMLS_FETCH();
	...
	/*static*/
	zend_object_value PHPUtils::PHPKObjectCreateObject(zend_class_entry *ce TSRMLS_DC)
	{
		PHPKObject* intern;
	...
	/*static*/
	zval* PHPUtils::PHPKObjectReadProperty(zval* zthis, zval* property, int type TSRMLS_DC)
	{
		PHPKObject* kthis = reinterpret_cast<PHPKObject*>(
	...
	/*static*/
	void PHPUtils::PHPKObjectWriteProperty(zval* zthis, zval* property, zval* value TSRMLS_DC)
	{
		PHPKObject* kthis = reinterpret_cast<PHPKObject*>(
			zend_object_store_get_object(zthis TSRMLS_CC));
		SharedKObject kobject = kthis->kvalue->ToObject();
	 ...
	 */
	/*static*/
	int PHPUtils::PHPKObjectHasProperty(zval* zthis, zval* property, int checkType TSRMLS_DC)
	{
		PHPKObject* kthis = reinterpret_cast<PHPKObject*>(
			zend_object_store_get_object(zthis TSRMLS_CC));
		SharedKObject kobject = kthis->kvalue->ToObject();
	 ...
	 */
	/*static*/
	int PHPUtils::PHPKObjectHasDimension(zval* zthis, zval* property, int checkType TSRMLS_DC)
	{
		PHPKObject* kthis = reinterpret_cast<PHPKObject*>(
			zend_object_store_get_object(zthis TSRMLS_CC));
		SharedKObject kobject = kthis->kvalue->ToObject();
	...
	/*static*/
	void PHPUtils::PHPKObjectUnsetProperty(zval* zthis, zval* property TSRMLS_DC)
	{
		PHPKObject* kthis = reinterpret_cast<PHPKObject*>(
			zend_object_store_get_object(zthis TSRMLS_CC));
		SharedKObject kobject = kthis->kvalue->ToObject();
